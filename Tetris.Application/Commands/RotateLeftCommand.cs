...
{
    public sealed class RotateLeftCommand : IGameCommand
    {
        private int MoveX;
        private int MoveY;
        ...
        {
            session.CurrentBlock.MoveLocation(MoveX, MoveY);
            session.CurrentBlock.RotateLeft();
            session.CurrentBlock.TSpinType = getTSpinType(session.Field, session.CurrentBlock);
        }
        ...
        {
            if (dummyblock.Direction == DirectionTypes.east || dummyblock.Direction == DirectionTypes.south)
            {
                dummyblock.MoveLocation(-1, 0);
                MoveX += -1;
            }
            else if (dummyblock.Direction == DirectionTypes.north || dummyblock.Direction == DirectionTypes.west )
            {
                dummyblock.MoveLocation(1, 0);
                MoveX += 1;
            }
